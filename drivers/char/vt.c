...
// LGE_CHANGE_S dangwoo.choi@lge.com 2010/03/27 - Retrieve 
struct vc_data* get_vc_data()
{
	return vc_cons[0].d;
}
// LGE_CHANGE_E dangwoo.choi@lge.com 2010/03/27
...
static void reset_terminal(struct vc_data *vc, int do_clear)
{
	...
	vc->vc_decom		= 0;
	vc->vc_decawm		= 1;
//LGE_CHANGE_S	bob.cho@lge.com hiding a cursor when boot.
#ifdef CONFIG_MACH_MSM7X27_ALESSI || CONFIG_MACH_MSM7X27_ELINI
	vc->vc_deccm		= 0;
#else
	vc->vc_deccm		= 1;
#endif
