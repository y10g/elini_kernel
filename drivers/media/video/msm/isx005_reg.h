...
{0x000b, 0x03, BYTE_LEN},    // PLL_CKSEL    
// Start john.park@lge.com 2010-06-30 LGE_Domestic	
{0x3208, 0x01   ,BYTE_LEN},		// FAST MODE CHANGE
// End john.park@lge.com 2010-06-30 LGE_Domestic	
...
{0x02B9, 0x30, BYTE_LEN},     // VIF_CLKCONFIG2    - 20100806 30 -> 64Mhz //11 -> 48Mhz  //10 ->96Mhz
...
{0x4044, 0xC012, WORD_LEN},    // 1SECCLK_ALL
{0x4046, 0x1815, WORD_LEN},    // 1SECCLK_HD_1_1
{0x402B, 0x85, BYTE_LEN},    // FPS_SENSALL
{0x402C, 0x9600, WORD_LEN},    // FPS_SENS_HD_1_1
{0x4060, 0xC012, WORD_LEN},    // PIXEL_CLK
{0x4062, 0x1815, WORD_LEN},    // PIXEL_CLK_HD_1_1
{0x403E, 0x5720, WORD_LEN},    // FLSHT50
{0x4074, 0x0521, WORD_LEN},    // FLSHT50_HD_1_1
{0x4040, 0x491f, WORD_LEN},    // FLSHT60
...
{0x4C14, 0xE002, WORD_LEN},    // FLC_OPD_HEIGHT_NORMAL_1_1
...
{0x000E, 0x00, BYTE_LEN},      // GPIO_FUNCSEL IRQ disable & UART enable
...
{0x0009, 0x18, BYTE_LEN },    // INCK_SET    0xX8 : 27Mhz  //0xX6 : 24Mhz 
...
tuning_reg_settings_array[] = 
{
  ...
  //091214
  // ISX005 START RELEASE 090910LEE
  ...
  // AGC MAX 18.2DB
  // MAX SHUTTER 110MS
  // ADJDEFAULT SHTMIN=0B9 AGCMIN=0
  //=========================================//
  
  //V_CXC_SHD_AVE_52.INISHD TARGET 52%
  ...
  { 0x42BD, 0x05  , BYTE_LEN },
  { 0x42BE, 0x05  , BYTE_LEN },
  { 0x42BF, 0x05  , BYTE_LEN },
  { 0x42C0, 0x05  , BYTE_LEN },
  { 0x42C1, 0x05  , BYTE_LEN },
  { 0x42C2, 0x05  , BYTE_LEN },
  { 0x42C3, 0x05  , BYTE_LEN },
  { 0x42C4, 0x05  , BYTE_LEN },
  { 0x42C5, 0x05  , BYTE_LEN },
  { 0x42C6, 0x0A  , BYTE_LEN },
  { 0x42C7, 0x19  , BYTE_LEN },
  { 0x42C8, 0x32  , BYTE_LEN },
  { 0x42C9, 0x3A  , BYTE_LEN },
  { 0x42CA, 0x3A  , BYTE_LEN },
  { 0x42CB, 0x3A  , BYTE_LEN },
  { 0x42CC, 0x32  , BYTE_LEN },
  { 0x42CD, 0x19  , BYTE_LEN },
  { 0x42CE, 0x0A  , BYTE_LEN },
  { 0x42CF, 0x0A  , BYTE_LEN },
  { 0x42D0, 0x28  , BYTE_LEN },
  { 0x42D1, 0x32  , BYTE_LEN },
  { 0x42D2, 0x41  , BYTE_LEN },
  { 0x42D3, 0x46  , BYTE_LEN },
  { 0x42D4, 0x41  , BYTE_LEN },
  { 0x42D5, 0x32  , BYTE_LEN },
  { 0x42D6, 0x28  , BYTE_LEN },
  { 0x42D7, 0x0A  , BYTE_LEN },
  { 0x42D8, 0x0A  , BYTE_LEN },
  { 0x42D9, 0x32  , BYTE_LEN },
  { 0x42DA, 0x3A  , BYTE_LEN },
  { 0x42DB, 0x46  , BYTE_LEN },
  { 0x42DC, 0x4B  , BYTE_LEN },
  { 0x42DD, 0x46  , BYTE_LEN },
  { 0x42DE, 0x3A  , BYTE_LEN },
  { 0x42DF, 0x32  , BYTE_LEN },
  { 0x42E0, 0x0A  , BYTE_LEN },
  { 0x42E1, 0x0A  , BYTE_LEN },
  { 0x42E2, 0x28  , BYTE_LEN },
  { 0x42E3, 0x32  , BYTE_LEN },
  { 0x42E4, 0x41  , BYTE_LEN },
  { 0x42E5, 0x46  , BYTE_LEN },
  { 0x42E6, 0x41  , BYTE_LEN },
  { 0x42E7, 0x32  , BYTE_LEN },
  { 0x42E8, 0x28  , BYTE_LEN },
  { 0x42E9, 0x0A  , BYTE_LEN },
  { 0x42EA, 0x0A  , BYTE_LEN },
  { 0x42EB, 0x19  , BYTE_LEN },
  { 0x42EC, 0x32  , BYTE_LEN },
  { 0x42ED, 0x3A  , BYTE_LEN },
  { 0x42EE, 0x3A  , BYTE_LEN },
  { 0x42EF, 0x3A  , BYTE_LEN },
  { 0x42F0, 0x32  , BYTE_LEN },
  { 0x42F1, 0x19  , BYTE_LEN },
  { 0x42F2, 0x0A  , BYTE_LEN },
  { 0x42F3, 0x05  , BYTE_LEN },
  { 0x42F4, 0x05  , BYTE_LEN },
  { 0x42F5, 0x05  , BYTE_LEN },
  { 0x42F6, 0x05  , BYTE_LEN },
  { 0x42F7, 0x05  , BYTE_LEN },
  { 0x42F8, 0x05  , BYTE_LEN },
  { 0x42F9, 0x05  , BYTE_LEN },
  { 0x42FA, 0x05  , BYTE_LEN },
  { 0x42FB, 0x05  , BYTE_LEN },
  ...
  { 0x521C, 0x5C00, WORD_LEN },
  { 0x521E, 0x6100, WORD_LEN },
  { 0x5220, 0x6500, WORD_LEN },
  { 0x5222, 0x6800, WORD_LEN },
  { 0x5224, 0x4C00, WORD_LEN },
  { 0x5226, 0x8200, WORD_LEN },
  { 0x5228, 0xA800, WORD_LEN },
  { 0x522A, 0xC200, WORD_LEN },
  { 0x522C, 0xD800, WORD_LEN }, //RGB-GAMMA R-KNOT22(TABLE0)
  { 0x522E, 0xEA00, WORD_LEN }, //RGB-GAMMA R-KNOT23(TABLE0)
  { 0x5230, 0xF700, WORD_LEN }, //RGB-GAMMA R-KNOT24(TABLE0)
  { 0x5232, 0xFB00, WORD_LEN }, //RGB-GAMMA R-KNOT25(TABLE0)
  { 0x5234, 0xFC00, WORD_LEN }, //RGB-GAMMA R-KNOT26(TABLE0)
  // //GAMMA G
  { 0x5236, 0x0000, WORD_LEN }, //RGB-GAMMA G-KNOT0(TABLE0)
  { 0x5238, 0x0100, WORD_LEN },//RGB-GAMMA G-KNOT1(TABLE0) 
  { 0x523A, 0x0300, WORD_LEN },//RGB-GAMMA G-KNOT2(TABLE0) 
  { 0x523C, 0x0C00, WORD_LEN },//RGB-GAMMA G-KNOT3(TABLE0) 
  { 0x523E, 0x1500, WORD_LEN },//RGB-GAMMA G-KNOT4(TABLE0) 
  { 0x5240, 0x2000, WORD_LEN },//RGB-GAMMA G-KNOT5(TABLE0) 
  ...
  { 0x5252, 0x5C00, WORD_LEN },//RGB-GAMMA G-KNOT14(TABLE0)  
  { 0x5254, 0x6100, WORD_LEN },//RGB-GAMMA G-KNOT15(TABLE0)  
  { 0x5256, 0x6500, WORD_LEN },//RGB-GAMMA G-KNOT16(TABLE0)  
  { 0x5258, 0x6800, WORD_LEN },//RGB-GAMMA G-KNOT17(TABLE0)
  { 0x525A, 0x4C00, WORD_LEN },//RGB-GAMMA G-KNOT18(TABLE0)
  { 0x525C, 0x8200, WORD_LEN },//RGB-GAMMA G-KNOT19(TABLE0)
  { 0x525E, 0xA800, WORD_LEN },//RGB-GAMMA G-KNOT20(TABLE0)
  ...
  { 0x5266, 0xF700, WORD_LEN }, //RGB-GAMMA G-KNOT24(TABLE0)
  { 0x5268, 0xFB00, WORD_LEN }, //RGB-GAMMA G-KNOT25(TABLE0)
  { 0x526A, 0xFC00, WORD_LEN }, //RGB-GAMMA G-KNOT26(TABLE0)
  // //GAMMA B
  ...
  { 0x5288, 0x5C00, WORD_LEN },
  { 0x528A, 0x6100, WORD_LEN },
  { 0x528C, 0x6500, WORD_LEN },
  { 0x528E, 0x6800, WORD_LEN },
  { 0x5290, 0x4C00, WORD_LEN },
  { 0x5292, 0x8200, WORD_LEN },
  { 0x5294, 0xA800, WORD_LEN },
  { 0x5296, 0xC200, WORD_LEN },
  { 0x5298, 0xD800, WORD_LEN }, //RGB-GAMMA B-KNOT22(TABLE0)
  { 0x529A, 0xEA00, WORD_LEN }, //RGB-GAMMA B-KNOT23(TABLE0)
  { 0x529C, 0xF700, WORD_LEN }, //RGB-GAMMA B-KNOT24(TABLE0)
  { 0x529E, 0xFB00, WORD_LEN }, //RGB-GAMMA B-KNOT25(TABLE0)
  { 0x52A0, 0xFC00, WORD_LEN }, //RGB-GAMMA B-KNOT26(TABLE0)
  ...
  { 0x52AE, 0x0022, WORD_LEN },//2200//CONVERGENCE LUMINANCE SETTING (TABLE0) 0709
  //Still gamma r   // john.park 100906  reduce redish tharough gamma table 
  { 0x5400, 0x0000, WORD_LEN },//rgb-gamma r-knot0(table0)   
  { 0x5402, 0x0000, WORD_LEN },//rgb-gamma r-knot1(table0)   
  { 0x5404, 0x0200, WORD_LEN },//rgb-gamma r-knot2(table0)   
  { 0x5406, 0x0900, WORD_LEN },//rgb-gamma r-knot3(table0)   
  { 0x5408, 0x1200, WORD_LEN },//rgb-gamma r-knot4(table0)   
  { 0x540a, 0x1D00, WORD_LEN },//rgb-gamma r-knot5(table0)   
  { 0x540c, 0x2700, WORD_LEN },//rgb-gamma r-knot6(table0)   
  { 0x540e, 0x2F00, WORD_LEN },//rgb-gamma r-knot7(table0)   
  { 0x5410, 0x3700, WORD_LEN },//rgb-gamma r-knot8(table0)   
  { 0x5412, 0x3F00, WORD_LEN },//rgb-gamma r-knot9(table0)   
  { 0x5414, 0x4600, WORD_LEN },//rgb-gamma r-knot10(table0)  
  { 0x5416, 0x4D00, WORD_LEN },//rgb-gamma r-knot11(table0)  
  { 0x5418, 0x5200, WORD_LEN },//rgb-gamma r-knot12(table0)  
  { 0x541a, 0x5700, WORD_LEN },//rgb-gamma r-knot13(table0)  
  { 0x541c, 0x5B00, WORD_LEN },//rgb-gamma r-knot14(table0)  
  { 0x541e, 0x6000, WORD_LEN },//rgb-gamma r-knot15(table0)  
  { 0x5420, 0x6300, WORD_LEN },//rgb-gamma r-knot16(table0)  
  { 0x5422, 0x6A00, WORD_LEN },//rgb-gamma r-knot17(table0)  
  { 0x5424, 0x5000, WORD_LEN },//rgb-gamma r-knot18(table0)  
  { 0x5426, 0x7B00, WORD_LEN },//rgb-gamma r-knot19(table0)  
  { 0x5428, 0xA500, WORD_LEN },//rgb-gamma r-knot20(table0)  
  { 0x542a, 0xC200, WORD_LEN },//rgb-gamma r-knot21(table0)  
  { 0x542c, 0xD800, WORD_LEN },//rgb-gamma r-knot22(table0)  
  { 0x542e, 0xEA00, WORD_LEN },//rgb-gamma r-knot23(table0)  
  { 0x5430, 0xF700, WORD_LEN },//rgb-gamma r-knot24(table0)  
  { 0x5432, 0xFB00, WORD_LEN },//rgb-gamma r-knot25(table0)  
  { 0x5434, 0xFC00, WORD_LEN },//rgb-gamma r-knot26(table0) 
  //g 
  { 0x5436, 0x0000, WORD_LEN },//rgb-gamma g-knot0(table0) 
  { 0x5438, 0x0100, WORD_LEN },//rgb-gamma g-knot1(table0) 
  { 0x543a, 0x0300, WORD_LEN },//rgb-gamma g-knot2(table0) 
  { 0x543c, 0x0C00, WORD_LEN },//rgb-gamma g-knot3(table0) 
  { 0x543e, 0x1500, WORD_LEN },//rgb-gamma g-knot4(table0) 
  { 0x5440, 0x2000, WORD_LEN },//rgb-gamma g-knot5(table0) 
  { 0x5442, 0x2A00, WORD_LEN },//rgb-gamma g-knot6(table0) 
  { 0x5444, 0x3200, WORD_LEN },//rgb-gamma g-knot7(table0) 
  { 0x5446, 0x3900, WORD_LEN },//rgb-gamma g-knot8(table0) 
  { 0x5448, 0x4100, WORD_LEN },//rgb-gamma g-knot9(table0) 
  { 0x544a, 0x4700, WORD_LEN },//rgb-gamma g-knot10(table0)
  { 0x544c, 0x4D00, WORD_LEN },//rgb-gamma g-knot11(table0)
  { 0x544e, 0x5200, WORD_LEN },//rgb-gamma g-knot12(table0)
  { 0x5450, 0x5700, WORD_LEN },//rgb-gamma g-knot13(table0)
  { 0x5452, 0x5B00, WORD_LEN },//rgb-gamma g-knot14(table0)
  { 0x5454, 0x6000, WORD_LEN },//rgb-gamma g-knot15(table0)
  { 0x5456, 0x6300, WORD_LEN },//rgb-gamma g-knot16(table0)
  { 0x5458, 0x6A00, WORD_LEN },//rgb-gamma g-knot17(table0)
  { 0x545a, 0x5000, WORD_LEN },//rgb-gamma g-knot18(table0)
  { 0x545c, 0x7B00, WORD_LEN },//rgb-gamma g-knot19(table0)
  { 0x545e, 0xA500, WORD_LEN },//rgb-gamma g-knot20(table0)
  { 0x5460, 0xC200, WORD_LEN },//rgb-gamma g-knot21(table0)
  { 0x5462, 0xD800, WORD_LEN },//rgb-gamma g-knot22(table0)
  { 0x5464, 0xEA00, WORD_LEN },//rgb-gamma g-knot23(table0)
  { 0x5466, 0xF700, WORD_LEN },//rgb-gamma g-knot24(table0)
  { 0x5468, 0xFB00, WORD_LEN },//rgb-gamma g-knot25(table0)
  { 0x546a, 0xFC00, WORD_LEN },//rgb-gamma g-knot26(table0)  
  //b  
  { 0x546c, 0x0000, WORD_LEN },//rgb-gamma b-knot0(table0) 
  { 0x546e, 0x0000, WORD_LEN },//rgb-gamma b-knot1(table0) 
  { 0x5470, 0x0200, WORD_LEN },//rgb-gamma b-knot2(table0) 
  { 0x5472, 0x0900, WORD_LEN },//rgb-gamma b-knot3(table0) 
  { 0x5474, 0x1200, WORD_LEN },//rgb-gamma b-knot4(table0) 
  { 0x5476, 0x1D00, WORD_LEN },//rgb-gamma b-knot5(table0) 
  { 0x5478, 0x2700, WORD_LEN },//rgb-gamma b-knot6(table0) 
  { 0x547a, 0x2F00, WORD_LEN },//rgb-gamma b-knot7(table0) 
  { 0x547c, 0x3700, WORD_LEN },//rgb-gamma b-knot8(table0) 
  { 0x547e, 0x3F00, WORD_LEN },//rgb-gamma b-knot9(table0) 
  { 0x5480, 0x4600, WORD_LEN },//rgb-gamma b-knot10(table0)
  { 0x5482, 0x4D00, WORD_LEN },//rgb-gamma b-knot11(table0)
  { 0x5484, 0x5200, WORD_LEN },//rgb-gamma b-knot12(table0)
  { 0x5486, 0x5700, WORD_LEN },//rgb-gamma b-knot13(table0)
  { 0x5488, 0x5B00, WORD_LEN },//rgb-gamma b-knot14(table0)
  { 0x548a, 0x6000, WORD_LEN },//rgb-gamma b-knot15(table0)
  { 0x548c, 0x6300, WORD_LEN },//rgb-gamma b-knot16(table0)
  { 0x548e, 0x6A00, WORD_LEN },//rgb-gamma b-knot17(table0)
  { 0x5490, 0x5000, WORD_LEN },//rgb-gamma b-knot18(table0)
  { 0x5492, 0x7B00, WORD_LEN },//rgb-gamma b-knot19(table0)
  { 0x5494, 0xA500, WORD_LEN },//rgb-gamma b-knot20(table0)
  { 0x5496, 0xC200, WORD_LEN },//rgb-gamma b-knot21(table0)
  { 0x5498, 0xD800, WORD_LEN },//rgb-gamma b-knot22(table0)
  { 0x549a, 0xEA00, WORD_LEN },//rgb-gamma b-knot23(table0)
  { 0x549c, 0xF700, WORD_LEN },//rgb-gamma b-knot24(table0)
  { 0x549e, 0xFB00, WORD_LEN },//rgb-gamma b-knot25(table0)
  { 0x54a0, 0xFC00, WORD_LEN },//rgb-gamma b-knot26(table0)
  { 0x54a2, 0x1003, WORD_LEN },//low-range setting/offset setting -r (table0   
  { 0x54a4, 0x0540, WORD_LEN },//low-range setting -r (table0) 
  { 0x54a6, 0x1003, WORD_LEN },//low-range setting/offset setting -g (table0   
  { 0x54a8, 0x0540, WORD_LEN },//low-range setting -g (table0) 
  { 0x54aa, 0x1003, WORD_LEN },//low-range setting/offset setting -b (table0   
  { 0x54ac, 0x0540, WORD_LEN },//low-range setting -b (table0) 
  { 0x54ae, 0x0022, WORD_LEN },//2200//convergence luminance setting (table0) 0709
  // AF DRIVER//
  ...
  { 0x480E, 0x5802, WORD_LEN }, //MINIMUM AF-OPD_TH VALUE FOR FIR // john.park 100903 , 0x7701
  { 0x4810, 0x5802, WORD_LEN }, //MAXIMUM AF-OPD_TH VALUE FOR FIR
  { 0x4812, 0xE803, WORD_LEN }, //AF SCALE OFFSET VALUE USED FOR AF_FIR_PEAK_OPD_TH_MIN
  // Start john.park@lge.com 2010-07-15 LGE_Domestic for AF focus tuning
  { 0x481D, 0x00  , BYTE_LEN }, //AF SCALE OFFSET VALUE USED FOR AF_FIR_PEAK_OPD_TH_MIN
  // End john.park@lge.com 2010-07-15 LGE_Domestic for AF focus tuning
  ...
  { 0x4844, 0x3c00, WORD_LEN }, // john.park 100907 0x5000//FINE SEARCH RANGE OFFSET
  { 0x484F, 0x00  , BYTE_LEN }, //EXPOSURE TIME-DEPENDENT LENS CONTROL FLAG
  { 0x4856, 0x28  , BYTE_LEN }, //
  { 0x486A, 0x6400, WORD_LEN }, //
  { 0x486C, 0x1E00, WORD_LEN }, //  // john.park 100907 0x2800//AF_DRV_AMOUNT_TONEAR_F
  { 0x486E, 0x1400, WORD_LEN },//AF_DRV_AMOUNT_TONEAR_S
  // LGE john.park MACRO focus //e1st  amount/2nd amount 설정 변경. (init 파일 내 변경)
  { 0x4870, 0x1E00, WORD_LEN }, //AF_DRV_AMOUNT_TONEAR_F
  { 0x4872, 0x0A00, WORD_LEN }, //AF_DRV_AMOUNT_TONEAR_S
  //0x4870, 0x2800, WORD_LEN },//AF_DRV_AMOUNT_TOFAR_F
  //0x4872, 0x1400, WORD_LEN },//AF_DRV_AMOUNT_TOFAR_S
  // LGE john.park AF focus //
  // LGE john.park MACRO focus// far pos: 170, near pos : 530 (init 파일 내 변경)
  //0x4876, 0x7C01, WORD_LEN }, //AF_AREA_LOW_TYPE1   380
  { 0x4876, 0xAA00, WORD_LEN },   //AF_AREA_LOW_TYPE1   170  
  { 0x4878, 0x1202, WORD_LEN },//AF_AREA_HIGH_TYPE1   530
  //0x4878, 0x4402, WORD_LEN }, //AF_AREA_HIGH_TYPE1  
  { 0x487A, 0x3200, WORD_LEN }, //AF_AREA_LOW_TYPE2   
	{0x487C, 0xFE01,WORD_LEN},	 //AF_AREA_HIGH_TYPE2	   410
  { 0x487E, 0x3200, WORD_LEN }, //AF_AREA_LOW_TYPE3   50
  { 0x4880, 0x4402, WORD_LEN }, //AF_AREA_HIGH_TYPE3   580
  
  { 0x4884, 0x00  , BYTE_LEN },  // AF_MONICHG_MOVE_F0 : CURRENT POSITION
  { 0x4889, 0x20  , BYTE_LEN },
  { 0x488A, 0x00  , BYTE_LEN },
  { 0x488B, 0x00  , BYTE_LEN },
  
  { 0x4887, 0x02, BYTE_LEN }, // john.park  100901  AF speed up
  ...
  { 0x46B0, 0x54  , BYTE_LEN },
  { 0x46B1, 0x37  , BYTE_LEN },
  { 0x46B2, 0x34  , BYTE_LEN },
  { 0x46B3, 0x32  , BYTE_LEN },
  { 0x46B4, 0x4C  , BYTE_LEN },
  ...
  { 0x46D7, 0x6A  , BYTE_LEN },
  { 0x46D8, 0x66  , BYTE_LEN },
  ...
  { 0x4706, 0x3D  , BYTE_LEN },// outaim_left22 : 
  { 0x4707, 0x3A  , BYTE_LEN },// outaim_left23 : 
  { 0x4708, 0x37  , BYTE_LEN },  // OUTAIM_LEFT24 : 
  { 0x4709, 0x35  , BYTE_LEN },// outaim_left25 : 
  { 0x470A, 0x33  , BYTE_LEN },// outaim_left26 : 
  { 0x470B, 0x32  , BYTE_LEN },// outaim_left27 : 
  ...
  { 0x472C, 0x47  , BYTE_LEN },// outaim_right22 :
  { 0x472D, 0x44  , BYTE_LEN },// outaim_right23 :
  { 0x472E, 0x42  , BYTE_LEN },// outaim_right24 :
  { 0x472F, 0x3F  , BYTE_LEN },// outaim_right25 :
  { 0x4730, 0x3C  , BYTE_LEN },// outaim_right26 :
  { 0x4731, 0x3A  , BYTE_LEN },// outaim_right27 :
  ...
  { 0x473C, 0x1C , BYTE_LEN },  // OUTAIM_TOP :  // john.park 10.12.15  before : 0x1B  
  { 0x473D, 0x16  , BYTE_LEN },// outaim_botm :// john.park 100826 , AWB range modified , before : 0x15  
  { 0x473E, 0x19  , BYTE_LEN },  // OUTAIM_FLTOP : 
  { 0x473F, 0x16  , BYTE_LEN },  // OUTAIM_FLBOTM : 
  { 0x0097, 0x01  , WORD_LEN },
  ...
  { 0x4464, 0xf003, WORD_LEN },
  { 0x4466, 0xf003, WORD_LEN },
  { 0x4468, 0xf003, WORD_LEN },
  ...
  // MAX FRAME
  // start john.park@lge.com 2010-06-24 LGE_Domestic
  { 0x01BD, 0x01  , BYTE_LEN }, // MAX FRAME TYPE1 NORMAL AE MODE 33MS
  { 0x01BE, 0x02  , BYTE_LEN }, // MAX FRAME TYPE2 LONG AE MODE  66MS FOR 1/2S
  { 0x01BF, 0x03  , BYTE_LEN }, // MAX FRAME TYPE3 LONG NIGHT MODE 250MS FOR 1/2S
  { 0x01C0, 0x03  , BYTE_LEN }, // MAX FRAME TYPE4 1SEC SHUTTER FOR DEBUG  500MS FOR 1S
  // End john.park@lge.com 2010-06-24 LGE_Domestic
  ...
  // Start john.park@lge.com 2010-06-24 LGE_Domestic
  // Pclk = 96Mhz, Preview 26.6 ~ 13.3 , Capture 13.3 ~ 9 fps , AE   INCK = 24MHZ, PLL = 432MHZ
  { 0x4A00, 0x0D05, WORD_LEN }, //MIN SHT START FROM 2LINE @CAPTURE
  { 0x4A02, 0x0000, WORD_LEN }, //MIN AGC
  // Exposure time tune by john.park 100825
  { 0x4016, 0x6D23, WORD_LEN }, // NORMSHTSCL_L : 22.2ms 
  { 0x4018, 0xca03, WORD_LEN }, // AGCLOWSCL_L : 5.7db  
  { 0x401A, 0x0002, WORD_LEN }, // EXPSHTSCL_L : 33.33ms  , 0x5702
  { 0x401C, 0xCA03, WORD_LEN }, // AGCHISCL_L : 16.00db, 0xFE02
  { 0x401E, 0x6C03, WORD_LEN }, //// MAXSHTSCL_L : 110.00ms  // john.park : 9 fps - 0xe306, 8.3fps -0x6407 in 20 lux , 1A02
  { 0x4020, 0xFF01, WORD_LEN }, // AGCMAXSCL_L : 18.33db , 0xCB02
  { 0x4036, 0x9F02, WORD_LEN }, //ISO SENSITIVITY ADJUSTMENT COEFFICIENT SET 090717// AE FRAME ?J?E?S??// TYPE3  090717
  // End john.park@lge.com 2010-06-24 LGE_Domestic
  
  // EV
  { 0x4087, 0x05  , BYTE_LEN }, // EVSEL_GAIN_P1_3EV +0.5
  { 0x4088, 0x0E  , BYTE_LEN }, // EVSEL_GAIN_P2_3
  { 0x4089, 0x0B  , BYTE_LEN }, // EVSEL_GAIN_P3_3EV +1
  { 0x408A, 0x0F  , BYTE_LEN }, // EVSEL_GAIN_P4_3EV +1.5
  { 0x408B, 0x21  , BYTE_LEN }, // EVSEL_GAIN_P5_3
  { 0x408C, 0x13  , BYTE_LEN }, // EVSEL_GAIN_P6_3EV +2
  { 0x408D, 0x06  , BYTE_LEN }, // EVSEL_GAIN_M1_3 EV -0.5
  { 0x408E, 0x0E  , BYTE_LEN }, // EVSEL_GAIN_M2_3
  { 0x408F, 0x0C  , BYTE_LEN }, // EVSEL_GAIN_M3_3EV -1
  { 0x4090, 0x13  , BYTE_LEN }, // EVSEL_GAIN_M4_3EV -1.5
  { 0x4091, 0x21  , BYTE_LEN }, // EVSEL_GAIN_M5_3
  { 0x4092, 0x18  , BYTE_LEN }, // EVSEL_GAIN_M6_3EV -2
  ...
  { 0x0112, 0x01  , BYTE_LEN },  // AE_SN4 : NORMAL AE
  ...
  //by sony 2010.09.17 HUE 수정
  { 0x5092, 0xF2FF, WORD_LEN },  //BYHUE REFERENCE VALUE (1ST QUADRANT), FOR AUTOMATIC CONTROL, POS1 
  ...
  { 0x509A, 0xFAFF, WORD_LEN },  //BYHUE REFERENCE VALUE (3RD QUADRANT), FOR AUTOMATIC CONTROL, POS1 
  { 0x509C, 0xEEFF, WORD_LEN },  //RYHUE REFERENCE VALUE (3RD QUADRANT), FOR AUTOMATIC CONTROL, POS1 
  { 0x509E, 0xF2FF, WORD_LEN },  //BYHUE REFERENCE VALUE (4TH QUADRANT), FOR AUTOMATIC CONTROL, POS1 
  { 0x50A0, 0xEEFF, WORD_LEN },  //RYHUE REFERENCE VALUE (4TH QUADRANT), FOR AUTOMATIC CONTROL, POS1 
  { 0x50A2, 0x60, BYTE_LEN },//RYGAIN REFERENCE VALUE (1ST QUADRANT),FOR AUTOMATIC CONTROL,POS1  
  { 0x50A3, 0x4c, BYTE_LEN },//BYGAIN REFERENCE VALUE (1ST QUADRANT),FOR AUTOMATIC CONTROL,POS1  
  { 0x50A4, 0x60, BYTE_LEN },//RYGAIN REFERENCE VALUE (2ND QUADRANT),FOR AUTOMATIC CONTROL,POS1  
  { 0x50A5, 0x4c, BYTE_LEN },//BYGAIN REFERENCE VALUE (2ND QUADRANT),FOR AUTOMATIC CONTROL,POS1  
  { 0x50A6, 0x60, BYTE_LEN },//RYGAIN REFERENCE VALUE (3RD QUADRANT),FOR AUTOMATIC CONTROL,POS1  
  { 0x50A7, 0x4c, BYTE_LEN },//BYGAIN REFERENCE VALUE (3RD QUADRANT),FOR AUTOMATIC CONTROL,POS1  
  { 0x50A8, 0x60, BYTE_LEN },//RYGAIN REFERENCE VALUE (4TH QUADRANT),FOR AUTOMATIC CONTROL,POS1  
  { 0x50A9, 0x4c, BYTE_LEN },//6DBYGAIN REFERENCE VALUE (4TH QUADRANT),FOR AUTOMATIC CONTROL,POS1
  ...
  { 0x0062, 0x20, BYTE_LEN },// 20 SHARPNESS 
  ...
  { 0x4F38, 0x13  , BYTE_LEN },// IR_DS_ADGRADLIM  = 10// A  
  { 0x4F39, 0x17  , BYTE_LEN },// IR_DS_ADGRADLIM  = 20// B 
  { 0x4F3A, 0x19  , BYTE_LEN },// IR_DS_ADGRADLIM  = 20// C 
  { 0x4F3B, 0x13  , BYTE_LEN },// IR_DS_HVGRADLIM  = 20// A 
  { 0x4F3C, 0x17  , BYTE_LEN },// IR_DS_HVGRADLIM  = 30// B 
  { 0x4F3D, 0x19  , BYTE_LEN },// IR_DS_HVGRADLIM  = 30// C 
  ...
  { 0x585A, 0xa406, WORD_LEN },// PICT_GAIN___GAIN_TH_B_TYPE0   =  918 
  { 0x585C, 0x8000, WORD_LEN },// PICT_GAIN___GAIN_TH_C_TYPE0   =0 
  { 0x5888, 0x1200, WORD_LEN },// IR_YN_LUMTH_A 0721 by sony   =   32// A
  { 0x588A, 0x1100, WORD_LEN },// IR_YN_LUMTH_B   =   11// B 
  { 0x588C, 0x0600, WORD_LEN },// IR_YN_LUMTH_C   =   10// C 
  { 0x588E, 0x3d00, WORD_LEN },// IR_LN_CTH _A 0721by sony   =   32// A
...
preview_mode_reg_settings_array[] = {
    {0x0097, 0x00   , BYTE_LEN},     //SONY 101020, AWB cont. shift
    {0x588E, 0x1200, WORD_LEN},  // john.park  100907  for optimizing the difference preview and snapshot.  
    {0x02A4, 0x0700, WORD_LEN},    // VADJ_SENS_1_2
    {0x01be, 0x02   , BYTE_LEN},  // MONI_REFRESH_F{              ,BYTE_LEN, 0},        
    {0x001C, 0x00   , BYTE_LEN},     // OUTPUT FORMAT MONITOR MODE
    {0x001F, 0x03   , BYTE_LEN},    //READVECT_MONI
    {0x0022, 0x8002, WORD_LEN},    //640*480 monitoring SIZE H
    {0x0028, 0xE001, WORD_LEN},    //640*480 monitoring SIZE V
...
snapshot_mode_reg_settings_array[] = {
    ...
    // Snapshot Setting
    //
    {0x588E, 0x2d00, WORD_LEN},  // john.park  100907  for optimizing the difference preview and snapshot.   
    {0x001D, 0x00   , BYTE_LEN},      //OUTPUT CAPTURE MODE
...
{
    {0x486A, 0x6400, WORD_LEN}, //sm.kwon 101108, back to normal position // john.park  100908  NT position change
    {0x00FC, 0x1F, BYTE_LEN},
    // LGE john.park AF focus 1   //by sony 2010.08.26 move
    {0x4844, 0x3c00,WORD_LEN},  // john.park 100907 0x5000  //FINE SEARCH RANGE OFFSET  // john.park  added for macro mode 
...
{
    {0x486A,0x6400,WORD_LEN},  // john.park  100908  NT position change to previous value : 0x6400
    {0x00FC, 0x1F, BYTE_LEN},
    // 2nd offset 변경  (if macro 모드 시에만)//by sony 2010.08.26 move
    {0x4844,0x2800,WORD_LEN}, //FINE SEARCH RANGE OFFSET  // john.park  added for macro mode 
    {0x4852, 0x1202, WORD_LEN},
...
{
    {0x4844,0x5000,WORD_LEN}, //FINE SEARCH RANGE OFFSET //by sony 2010.08.26 move
...
static struct isx005_register_address_value_pair const
af_start_low_light_reg_settings_array[] =
{
    {0x0097,0x01, BYTE_LEN},     //SONY 101020, AWB cont. shift
    {0x01F8,0x56, BYTE_LEN},
    {0x480E,0x2B00,WORD_LEN},   //MINIMUM AF-OPD_TH VALUE FOR FIR  // 100806  john.park --> 0x4B00 , 0x2B00
    {0x4810,0x2B00,WORD_LEN},   //MAXIMUM AF-OPD_TH VALUE FOR FIR // 100806  john.park --> 0x4B00, 0x2B00
    {0x002E, 0x00 ,BYTE_LEN},    // AF_MODE 0 : SINGLE_AF
    {0x0012, 0x01 ,BYTE_LEN},    // MONI_REFRESH
};

static struct isx005_register_address_value_pair const
af_start_high_light_reg_settings_array[] =
{
    {0x0097,0x00, BYTE_LEN},     //SONY 101020, AWB cont. shift
    {0x01F8,0x55, BYTE_LEN},
    {0x480E,0x5802,WORD_LEN},   //MINIMUM AF-OPD_TH VALUE FOR FIR  // 100806  john.park --> 0x4B00
    {0x4810,0x5802,WORD_LEN},   //MAXIMUM AF-OPD_TH VALUE FOR FIR // 100806  john.park --> 0x4B00
    {0x002E, 0x00 ,BYTE_LEN},    // AF_MODE 0 : SINGLE_AF
    {0x0012, 0x01 ,BYTE_LEN},    // MONI_REFRESH
};
...
scene_mode_auto_reg_settings_array[] = 
{
    // Pclk = 96Mhz, Preview 26.6 ~ 13.3 , Capture 13.3 ~ 9 fps , AE   INCK = 24MHZ, PLL = 432MHZ
    {0x4887,0x02,BYTE_LEN},     // john.park  100901  AF speed up
    {0x486c,0x1E00,WORD_LEN},// john.park 100907 0x2800 // john.park  100901  AF speed up
    {0x4870,0x1E00,WORD_LEN},// john.park  100901  AF speed up    
    {0x0100, 0x00, BYTE_LEN},  // SCENE_SELECT :                                       
    {0x0062, 0x20, BYTE_LEN},  // UISHARPNESS[7:0]   ?????? -1  //by sony 2010.08.26 수정                                                 
     // Pclk = 96Mhz, Preview 26.6 ~ 13.3 , Capture 13.3 ~ 9 fps , AE   INCK = 24MHZ, PLL = 432MHZ
    {0x4A00,0x0D05,WORD_LEN}, //MIN SHT START FROM 2LINE @CAPTURE
    {0x4A02,0x0000,WORD_LEN}, //MIN AGC
    {0x4016,0x6D23,WORD_LEN}, // NORMSHTSCL_L : 22.2ms                                                         
    ...
    {0x401A,0x0002,WORD_LEN}, // EXPSHTSCL_L : 33.33ms  ,0x5702
    {0x401C,0xCA03,WORD_LEN}, // AGCHISCL_L : 16.00db, 0xFE02
    {0x401E,0x6C03,WORD_LEN}, //// MAXSHTSCL_L : 110.00ms  // john.park : 9 fps - 0xe306, 8.3fps -0x6407 in 20 lux 
    {0x4020,0xFF01,WORD_LEN}, // AGCMAXSCL_L : 18.33db
    // End john.park@lge.com 2010-06-24 LGE_Domestic     
};
  ...
  scene_mode_sports_reg_settings_array[] =
{
    ...
    {0x4A00, 0x0D05, WORD_LEN},  //MIN SHT START FROM 2LINE @CAPTURE
    {0x4A02, 0x0000, WORD_LEN},  //MIN AGC
    {0x4016,0xff15, WORD_LEN},  // NORMSHTSCL_L : 60MS
    {0x4018, 0x9604, WORD_LEN},  // AGCLOWSCL_L : 3DB  
    {0x401A,0x3608,WORD_LEN}, // EXPSHTSCL_L : 33.33ms  ,0x5702
    {0x401C,0xcd00,WORD_LEN}, // AGCHISCL_L : 16.00db, 0xFE02
    {0x401E,0x0504,WORD_LEN}, //// MAXSHTSCL_L : 110.00ms  // john.park : 9 fps - 0xe306, 8.3fps -0x6407 in 20 lux , 1A02
    {0x4020,0x3202,WORD_LEN}, // AGCMAXSCL_L : 18.33db , 0xCB02
};
...
{
    {0x4887,0x00,BYTE_LEN},     // john.park  100901  AF speed up
    {0x486c,0x3C00,WORD_LEN},// john.park  100901  AF speed up
    {0x4870,0x3200,WORD_LEN},// john.park  100901  AF speed up
    {0x4A00,0x0D05,WORD_LEN}, //MIN SHT START FROM 2LINE @CAPTURE
    {0x4A02,0x0000,WORD_LEN}, //MIN AGC
    {0x4016,0x6D23,WORD_LEN}, // NORMSHTSCL_L : 22.2ms                                                         
    {0x4018,0xca03,WORD_LEN}, // AGCLOWSCL_L : 5.7db  
    {0x401A,0x0002,WORD_LEN}, // EXPSHTSCL_L : 33.33ms  ,0x5702
    {0x401C,0xCA03,WORD_LEN}, // AGCHISCL_L : 16.00db, 0xFE02
    {0x401E, 0xF307, WORD_LEN},  // MAxSHTSCL_L  // john.park  100906  0x3204
    {0x4020, 0xFF01, WORD_LEN},  // AGCMAxSCL_L : 18.3DB  
...
struct isx005_reg isx005_regs = {
  ...
  .af_start_low_light_reg_settings = af_start_low_light_reg_settings_array,
  .af_start_low_light_reg_settings_size = ARRAY_SIZE(
    af_start_low_light_reg_settings_array),

  .af_start_high_light_reg_settings = af_start_high_light_reg_settings_array,
  .af_start_high_light_reg_settings_size = ARRAY_SIZE(
    af_start_high_light_reg_settings_array),
