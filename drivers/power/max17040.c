...
/* LGE_CHANGE_S, DCM_JP [taesiks.kim@lge.com], 2010-11-12 taesiks.kim :: Fuel Gauge Display error (quick start delete)    */
	//max17040_write_reg(max17040_dev->client, 0x06, 0x40); max17040_write_reg(max17040_dev->client, 0x07, 0x00);
/* LGE_CHANGE_E, DCM_JP [taesiks.kim@lge.com], 2010-11-12 taesiks.kim :: Fuel Gauge Display error (quick start delete)    */
