...
/*LGE_CHANGE_S,DCM_JP[heari.kim@lge.com,10/12/31,<PCB Main borad reset modify > Elini]*/
#include "../../../arch/arm/mach-msm/smd_private.h" 
int* cam_preview;
/*LGE_CHANGE_E,DCM_JP[heari.kim@lge.com,10/12/31,< > Elini]*/
...
{
#if !defined(CONFIG_MACH_MSM7X27_THUNDERG) && !defined(CONFIG_MACH_MSM7X27_ALESSI) && !defined(CONFIG_MACH_MSM7X27_ELINI)
	int rc;
...
#if (defined(CONFIG_MACH_MSM7X27_THUNDERG) ||  defined(CONFIG_MACH_MSM7X27_ALESSI) || defined(CONFIG_MACH_MSM7X27_ELINI)) && defined(CONFIG_PM)
...
/*LGE_CHANGE_S,DCM_JP[heari.kim@lge.com,10/12/31,< PCB Main borad reset modify > Elini]*/		
	      cam_preview=smem_alloc(SMEM_ID_VENDOR2_CAMERA_PREVIEW, sizeof(int));		
            //dev_info(&pdev->dev, "%s : cam_preview==> (%d)\n", __func__, *cam_preview);
/*LGE_CHANGE_E,DCM_JP[heari.kim@lge.com,10/12/31,< > Elini]*/
	}
