...
static int ami304_ioctl(struct inode *inode, struct file *file, unsigned int cmd,unsigned long arg)
{
	...
	int mode=0;
        ...
        //LGE_CHANGE_S, [MYUNGWON.KIM@lge.com], 2010-12-31, <Block Root Authorization Check>
        //check the authority is root or not
        //      if(!capable(CAP_SYS_ADMIN)) {
        //        retval = -EPERM;
        //        goto err_out;
        //	}
        //LGE_CHANGE_E, [MYUNGWON.KIM@lge.com], 2010-12-31, <Block Root Authorization Check>
