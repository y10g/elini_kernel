...
/*LGE_CHANGE_S,DCM_JP[heari.kim@lge.com,10/12/08,<during the camera mode  > Elini]*/
//#include "../../../../arch/arm/mach-msm/smd_private.h" 
/*LGE_CHANGE_S,DCM_JP[heari.kim@lge.com,10/12/08,< > Elini]*/
