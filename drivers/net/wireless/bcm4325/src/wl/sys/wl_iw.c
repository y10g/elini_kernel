...
)
{
	...
	//20101110 Wi-Fi taewonee.kim@lge.com - country code fixed [START]
	case 14: strcpy(buf, "AU"); break; //fil
	//case 14: strcpy(buf, "JP"); break; //ori
	//20101110 Wi-Fi taewonee.kim@lge.com - country code fixed [END]
	default: return -EINVAL;
	}
