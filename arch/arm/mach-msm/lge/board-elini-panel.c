/* arch/arm/mach-msm/board-elini-panel.c
...
#if defined(CONFIG_MACH_MSM7X27_THUNDERG) || defined(CONFIG_MACH_MSM7X27_ELINI)
		/* LGE_CHANGE
...
void __init elini_init_i2c_backlight(int bus_num)
{
...
void __init lge_add_lcd_devices(void)
{
	...
	lge_add_gpio_i2c_device(elini_init_i2c_backlight);
}
