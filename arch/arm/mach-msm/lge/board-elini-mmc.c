/* arch/arm/mach-msm/lge/board-elini-mmc.c
...
#ifdef CONFIG_MMC_MSM_CARD_HW_DETECTION
static unsigned int elini_sdcc_slot_status(struct device *dev)
{
//LGE_UPDATE_S BCPARK 2010.04.05 for detection memory card
...
#endif
//LGE_UPDATE_E BCPARK 2010.04.05 for detection memory card
}
#endif
...
//LGE_UPDATE_S kwangrim.ha@lge.com 2010.07.22 for detection memory card
#ifdef CONFIG_MACH_MSM7X27_ELINI
