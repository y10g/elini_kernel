...
#define DUTY_MAX_TIME		3
#define DUTY_MIN_TIME		3
...
//static atomic_t s_amp = ATOMIC_INIT(125);
static atomic_t s_amp = ATOMIC_INIT(80);
...
/* LGE_CHANGES_S [tei.kim@lge.com] remove the warnning message, 2010-03-29 */
static void pwm_gen(struct vibrator_device *vib_dev)
{
/* LGE_CHANGES_E [tei.kim@lge.com] 2010-03-29 */
	int amp, gain;
	amp = atomic_read(&s_amp);
...
MODULE_DESCRIPTION("ELINI vibrator driver for Android");
MODULE_LICENSE("GPL");
